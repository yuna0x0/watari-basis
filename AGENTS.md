...
selectors and radial puppets rebuilt as HVR Vixxy controls, VRCFury toggles and full controllers
read from the original avatar, animation that plays on its own
